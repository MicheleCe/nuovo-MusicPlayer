...
function containerAlbum(songTitle, albumCover, artistName, albumtitle, artistPicture, track) {
  return `
  <div class="classCont col-12 col-md-3 text-light">
      <div class="card shadow my-3 position-relative border-0 bg-dark m-3" >
          ...
          <button onclick='playMusic("${track}")'>p</button>
...
song = "easter-island-5-minute-md-recording-of-waves-crashing-against-volcanic-ro1-17728.mp3"
let audio = new Audio(song)


function playMusic(onclickSong) {

  document.querySelector(".songsuore").innerText = ""
  document.querySelector(".songsuore").innerText = `${onclickSong}`
  let m = document.querySelector(".songsuore").innerText
  let audio = new Audio(m)
  audio.pause()
